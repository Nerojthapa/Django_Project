...
def addproduct(request):
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.ERROR, 'Kindly veryfy input value are added correctly!')
...
def updateproduct(request, product_id):
    ...
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.ERROR, 'Kindly verfiy all the fields properly')
...
def updatecategory(request, category_id):
    instance = Product.objects.get(id=category_id)
    if request.method=="POST":
